...
'<Assembly: System.Diagnostics.CodeAnalysis.SuppressMessage("Style", "IDE0044:Add readonly modifier", Justification:="<Pending>", Scope:="member", Target:="~F:PlatformerGameEngine.FrmActorMaker.delayTimer")>
'<Assembly: System.Diagnostics.CodeAnalysis.SuppressMessage("Code Quality", "IDE0069:Disposable fields should be disposed", Justification:="<Pending>", Scope:="member", Target:="~F:PlatformerGameEngine.FrmActorMaker.delayTimer")>
...
'<Assembly: System.Diagnostics.CodeAnalysis.SuppressMessage("Code Quality", "IDE0069:Disposable fields should be disposed", Justification:="<Pending>", Scope:="member", Target:="~F:PlatformerGameEngine.FrmLevelEditor.delayTimer")>