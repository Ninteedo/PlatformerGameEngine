...
#Region "General Procedures"
    ...
    Private Function RemoveItem(Of t)(ByVal array As t(), ByVal removeIndex As Integer) As t()
    ...
    Private Function InsertItem(Of t)(ByVal array As t(), ByVal newItem As t, Optional insertIndex As Integer = -1) As t()
